  ...
  outputs = { self, nixpkgs, flake-utils }:
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
      {
        ...
        apps = {
          default = flake-utils.lib.mkApp { drv = vice; name = "vice-app"; };
          vice = flake-utils.lib.mkApp { drv = vice; name = "vice"; };
          vice-app = flake-utils.lib.mkApp { drv = vice; name = "vice-app"; };
        };
